...
public interface ClientesApi {
    ...
    @ApiOperation(value = "Consulta todos os clientes.", nickname = "consultarTodos", notes = "Esta operação tem por objetivo consultar todos os clientes", response = Clientes.class, tags={ "Consulta", })
    @ApiResponses(value = { 
